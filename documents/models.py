...
class ClinicalDocument(models.Model):
    ...
    authors = models.ManyToManyField("clinical.Practitioner", blank=True, related_name="authored_documents")
    ...
    related_documents = models.ManyToManyField("self", blank=True, symmetrical=False, related_name="related_to_documents")
