...
urlpatterns = [
    ...
    path('admin/clinical/resources/fhir-explorer/', admin.site.admin_view(fhir_explorer), name='fhir_explorer'),
    path('admin/clinical/new-clinical-resources/', admin.site.admin_view(new_clinical_resources_directory), name='new_clinical_resources_directory'),
