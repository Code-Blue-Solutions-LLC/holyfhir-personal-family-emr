...
[x] normal person clinical dashboard, with admin pages mostly hidden but relevant ones shown (Clinical Resources)
[x] in fact, make an admin area for all the stuff (FHIR Explorer)